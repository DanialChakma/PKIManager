...
public class EurekaClientSSLConfig {
    ...
    private static final String KEYSTORE_PATH = "src/main/resources/mTLS/customerService-keystore.p12";
    private static final String KEY_ALIAS = "customerservice";
    private static final String TRUSTSTORE_PATH = "src/main/resources/mTLS/customerService-truststore.p12";
